class MyPost extends HTMLElement {
    static get observedAttributes() {
        return ['username', 'ubicacion', 'numerolikes','usernamecomentario', 'micomentario1', 'micomentario2', 'fechapublicacion']
    }
    ...
    render() {
        ...
        <section class="fondoGeneral">
            ...
            <img id="HTML-JS-NODE-CSS" src="./assets/HTML-JS-NODE-CSS.png">
            ...
            <img id="likePequeño" src="./assets/likePequeño.png">
            <h1 id="numeroLikes">${this.numerolikes}</h1>
